...
public class ArtistResponseTemplate implements EmailTemplate {
  ...
  public String getTemplate() {
    ...
    stringBuffer.append(
      "                                                style=\"font-size: 14px; line-height: 45px; text-align: left; margin: 0;\"><span style=\"font-size: 30px;\">{{USER NAME}} has been notified of your response!</span></p>\n");
    stringBuffer.append("                                        </div>\n");
    stringBuffer.append("                                    </div>\n");
    stringBuffer
      .append("                                    <!--[if mso]></td></tr></table><![endif]-->\n");
