...
public class ClientPhotoTemplate implements EmailTemplate {
  ...
  public String getTemplate() {
    ...
    stringBuffer.append("    <meta content=\"width=device-width\" name=\"viewport\"/>\n");
    stringBuffer.append("    <!--[if !mso]><!-->\n");
    stringBuffer.append("    <meta content=\"IE=edge\" http-equiv=\"X-UA-Compatible\"/>\n");
    ...
    stringBuffer.append(
      "                                                    style=\"font-size: 14px; line-height: 40px; margin: 0;\"><span style=\"font-size: 34px; color: #ffffff;\"><span style=\"font-size: 20px; line-height: 24px;\">You've been sent a photo of a tattoo you did for</span></span></p>\n");
    stringBuffer.append(
    ...
    stringBuffer.append("                                            <p\n");
    stringBuffer.append(
      "                                                    style=\"font-size: 14px; line-height: 36px; margin: 0;\"><span style=\"color: #202431; font-size: 30px;\"><strong><span style=\"line-height: 36px; font-size: 30px;\">Tattoo image.</span></strong></span></p>\n");
    stringBuffer.append("                                        </div>\n");
    stringBuffer.append("                                    </div>\n");
    stringBuffer
      .append("                                    <!--[if mso]></td></tr></table><![endif]-->\n");
    ...
    stringBuffer
      .append("                                            <img align=\"center\" alt=\"Image\"\n");
    stringBuffer.append("                                                 border=\"0\"\n");
    stringBuffer
      .append("                                                 class=\"center fixedwidth\"\n");
    stringBuffer
      .append("                                                 src=\"{{TATTOO IMGURL}}\"\n");
    stringBuffer.append(
      "                                                 style=\"outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; border: 0; height: auto; float: none; width: 100%; display: block;\" title=\"Image\"/>\n");
    stringBuffer.append("                                        </div>\n");
    stringBuffer.append("                                    </div>\n");
    stringBuffer
      .append("                                    <!--[if mso]></td></tr></table><![endif]-->\n");
    ...
    stringBuffer.append("                                            <p\n");
    stringBuffer.append(
      "                                                    style=\"font-size: 14px; line-height: 16px; margin: 0;\"><span style=\"color: #202431; font-size: 14px; line-height: 16px;\"><strong><span style=\"font-size: 38px; line-height: 45px;\">Think it looks good?</span></strong></span></p>\n");
    stringBuffer.append("                                        </div>\n");
    stringBuffer.append("                                    </div>\n");
    stringBuffer
      .append("                                    <!--[if mso]></td></tr></table><![endif]-->\n");
    ...
    stringBuffer.append("                                            <p\n");
    stringBuffer.append(
      "                                                    style=\"font-size: 14px; line-height: 16px; margin: 0;\"><span style=\"color: #202431; font-size: 14px; line-height: 16px;\"> If you think it looks good why not send an email to {{CLIENT NAME}} personally to let them know!</span></p>\n");
    stringBuffer.append("                                            <p\n");
    stringBuffer.append(
      "                                                    style=\"font-size: 14px; line-height: 16px; margin: 0;\"><br/><span style=\"color: #202431; font-size: 14px; line-height: 16px;\">Otherwise, get in contact to sort out a touch up!</span><br/></p>\n");
    stringBuffer.append("                                        </div>\n");
    stringBuffer.append("                                    </div>\n");
    stringBuffer
      .append("                                    <!--[if mso]></td></tr></table><![endif]-->\n");
